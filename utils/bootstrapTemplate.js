export function bootstrapTemplate() {
  ...
  let initialDate = new Date(),
    ...
    plugins = {
      ...
      bootstrapAccordion: $(".accordion-custom-item"),
      ...
      materialParallax: $(".parallax-container:not(.inited)"),
      ...
      search: $(".rd-search"),
      slick: $(".slick-slider:not(.slick-initialized)"),
  ...
  $(function () {
    ...
    if (plugins.bootstrapAccordion.length) {
      for (let i = 0; i < plugins.bootstrapAccordion.length; i++) {
        ...
        let accordionHead = accordionItem.querySelector(
